			...
			">
			  <tbody>
				<tr>
					...
					">
					  <tbody>
						<tr>
						  <td height="100" 
						  style="
						  background-image: url("/var/www/tourgoapp.com/tourgo.web/email-img/MainLOGO@2x.png");
				  ...
				  ">
					<p style="
					background-image: url("/var/www/tourgoapp.com/tourgo.web/email-img/tourgoers.png");
				  ...
				  ">
					<tbody>
					  <tr>
						...
						background-image: url("/var/www/tourgoapp.com/tourgo.web/email-img/london_info.png");
						...
						border-collapse: separate;">
						  <tbody>
							<tr>
							  ...
							  background-color: #00609B;
							  background-image: url("/var/www/tourgoapp.com/tourgo.web/email-img/iconLogo.png");
							  background-repeat: no-repeat;
